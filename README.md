Некоторые компоненты были сделаны кастомными, некоторые из библиотеки primevue, это сдлано для того, чтобы показать что я не только использую готовые компоненты но и пишу свой кастом.
